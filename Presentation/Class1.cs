...
namespace Presentation
{
    class Class1
    {
        ...
        public void player2ChosenShips(bool allShipsChosen, int userShipChosen, List<int> player1ChosenShips, bool allShipsChosenP1, List<string> player1ShipCoordinates, string playerPlaying, int ongoingGame)
        {
            do
            {
...
*/
        ...
        public void player1ChosenShips(bool allShipsChosen, int userShipChosen, List<int> player1ChosenShips, bool allShipsChosenP1, List<string> player1ShipCoordinates, string playerPlaying, int ongoingGame)
        {
            do
            {
                userShipChosen = gettingUserInput(player1ChosenShips);
...
*/
            ...
            Console.WriteLine("pick a new pallsadasd");
